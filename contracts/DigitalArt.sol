...
/// @notice create new item object with the item ID value and pass in the parameters
        ...
        contractIsActive
    {
        ...
        _artItemIds++;  /// @notice increment item ID 
...
/// @return integers and string for the ID
...
/// @return the token ID, incremented as a new ID
...
/// @param for the tranfer is the destination sellers address and the value
